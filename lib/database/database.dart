...
class User {
  ...
  User.fromMap(Map<String, dynamic>? map)
      : name = (map ?? defMap)['name'] ?? 'NullFieldError',
        ...
        isFoodTaken = (map ?? defMap)['isCheckedOut'] ?? 'NullFieldError';

  void displayData() => debugPrint(
      'debug: $name $regId $entryTime $exitTime $isCheckedIn $isCheckedOut $isFoodTaken');
}
